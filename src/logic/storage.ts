...
export const storageCustomLayoutDB = useStorageIndexDB('custom_layout_db', '++index, x, y, width, height, rotate, scale, isLocked, showMode, children') // 0 pined 1 most used
